...
time = stations_AQ_data.(['pd_', station_ID]).time;
AQI = stations_AQ_data.(['pd_', station_ID]).AQI;
SO2 = stations_AQ_data.(['pd_', station_ID]).SO2;
PM2p5 = stations_AQ_data.(['pd_', station_ID]).PM2p5;
PM10 = stations_AQ_data.(['pd_', station_ID]).PM10;
NO2 = stations_AQ_data.(['pd_', station_ID]).NO2;
O3 = stations_AQ_data.(['pd_', station_ID]).O3;
CO = stations_AQ_data.(['pd_', station_ID]).CO;
