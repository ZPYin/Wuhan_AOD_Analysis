...
AQI_DataFolder = 'D:\Data\全国空气质量\v_202101';   % 全国空气质量数据根目录，压缩文件解压到的目录
city = '保定';   % 需要提取数据的城市名称，注意城市名称需要从《站点列表***》里面选取
station_city_lookup_file = '站点列表-2020.12.06起.csv';   % 站点列表文件
matFilename = 'Baoding_air_quality_data.mat';   % 保存的数据文件名称，最好区分不同城市
