...
ax6 = subplot('Position', figPos(6, :), 'Units', 'Normalized');

flagNonZero = abs(yearlyAQILevel_organize(:, 6)) > 1e-5;
p6 = pie(ax6, yearlyAQILevel_organize(flagNonZero, 6));   % 将对应饼状图元素分离显示（防止重叠）
title('2020', 'FontSize', 14);

colormap(ax6, AQILevel_color_organize(flagNonZero, :));
