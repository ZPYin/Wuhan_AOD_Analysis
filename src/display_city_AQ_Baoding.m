...
%% initialization
matFile = 'Baoding_air_quality_data.mat';
tRange = [datenum(2014, 3, 1), datenum(2020, 12, 31)];   % 需要分析的时间序列的起始时间和结束时间
analysis_year_list = 2015:2020;   % 需要显示的年份序列（如：2015, 2016, 2017, 2018, 2019, 2020）

% settings for data visualization
figFilename1 = 'time-series-AQ-Baoding.png';   % 图片保存的文件名（图片目录为当前项目主目录下的img目录）
figFilename2 = 'diurnal-AQ-Baoding.png';
figFilename3 = 'seasonal-AQ-Baoding.png';
figFilename4 = 'yearly-AQ-Baoding.png';
figFilename5 = 'seasonal-diurnal-PM-Baoding.png';
figFilename6 = 'seasonal-diurnal-AQI-Baoding.png';
figFilename7 = 'seasonal-diurnal-SO2-Baoding.png';
figFilename8 = 'seasonal-diurnal-NO2-Baoding.png';
figFilename9 = 'seasonal-diurnal-O3-Baoding.png';
figFilename10 = 'AQI-level-Baoding.png';
AQIRange = [0, 300];   % AQI显示范围
PMRange = [0, 400];   % PM（2.5 or 10）显示范围
SO2Range = [0, 300];   % SO2显示范围
NO2Range = [0, 150];   % NO2显示范围
O3Range = [0, 250];   % O3显示范围
CORange = [0, 5];   % CO显示范围

% AQI level and color settings
...
for iMonth = 1:1:(nMonths/4)
    if datenum(thisYear, 1 + (iMonth - 1) * 6, 1) <= time(end)
        dates6Months = cat(2, dates6Months, datenum(thisYear, 1 + (iMonth - 1) * 6, 1));
    end
end
...
yTicks = linspace(PMRange(1), PMRange(2), 6);
set(gca, 'XTick', dates6Months, 'YTick', yTicks(2:(end - 1)), 'XTickLabel', '', 'YMinorTick', 'on', 'Box', 'on', 'LineWidth', 2, 'TickLen', [0.01, 0.01]);
xlim(tRange);
...
yTicks = linspace(AQIRange(1), AQIRange(2), 6);
set(gca, 'XTick', dates6Months, 'YTick', yTicks(2:(end - 1)), 'XTickLabel', '', 'YMinorTick', 'on', 'Box', 'on', 'LineWidth', 2, 'TickLen', [0.01, 0.01]);
xlim(tRange);
...
yTicks = linspace(SO2Range(1), SO2Range(2), 6);
set(gca, 'XTick', dates6Months, 'YTick', yTicks(2:(end - 1)), 'XTickLabel', '', 'YMinorTick', 'on', 'Box', 'on', 'LineWidth', 2, 'TickLen', [0.01, 0.01]);
xlim(tRange);
...
yTicks = linspace(NO2Range(1), NO2Range(2), 6);
set(gca, 'XTick', dates6Months, 'YTick', yTicks(2:(end - 1)), 'XTickLabel', '', 'YMinorTick', 'on', 'Box', 'on', 'LineWidth', 2, 'TickLen', [0.01, 0.01]);
xlim(tRange);
...
yTicks = linspace(O3Range(1), O3Range(2), 6);
set(gca, 'XTick', dates6Months, 'YTick', yTicks(1:(end - 1)), 'YMinorTick', 'on', 'Box', 'on', 'LineWidth', 2, 'TickLen', [0.01, 0.01]);
...
yTicks = linspace(CORange(1), CORange(2), 6);
set(gca, 'XTick', dates6Months, 'YTick', yTicks(1:(end - 1)), 'YMinorTick', 'on', 'Box', 'on', 'LineWidth', 2, 'TickLen', [0.01, 0.01]);
datetick(gca, 'x', 'yyyy-mm', 'keepticks', 'keeplimits');
xlim();
xtickangle(45);
...
export_fig(gcf, fullfile(projectDir, 'img', figFilename1), '-r300');
% saveas(gcf, fullfile(projectDir, 'img', 'time-series-AQ-wuhan.fig'));   % 保存成matlab可以编辑的fig文件
...
yTicks = linspace(PMRange(1), PMRange(2), 6);
set(gca, 'XTick', diurnalTime(1:2:end), 'YTick', yTicks(2:(end - 1)), 'XTickLabel', '', 'YMinorTick', 'on', 'Box', 'on', 'LineWidth', 2, 'TickLen', [0.01, 0.01]);
...
yTicks = linspace(O3Range(1), O3Range(2), 6);
set(gca, 'XTick', diurnalTime(1:2:end), 'YTick', yTicks(1:(end - 1)), 'YMinorTick', 'on', 'Box', 'on', 'LineWidth', 2, 'TickLen', [0.01, 0.01]);
datetick(gca, 'x', 'HH', 'keepticks', 'keeplimits');
xlim([0, 1]);
...
set(findall(gcf, '-Property', 'FontName'), 'FontName', 'Times New Roman');
export_fig(gcf, fullfile(projectDir, 'img', figFilename2), '-r300');
...
yTicks = linspace(PMRange(1), PMRange(2), 6);
set(gca, 'XTick', seasonalTime, 'YTick', yTicks(2:(end - 1)), 'XTickLabel', '', 'YMinorTick', 'on', 'Box', 'on', 'LineWidth', 2, 'TickLen', [0.01, 0.01]);
datetick(gca, 'x', 'HH', 'keepticks', 'keeplimits');
xlim([0, 5]);
...
yTicks = linspace(O3Range(1), O3Range(2), 6);
set(gca, 'XTick', seasonalTime, 'XTickLabel', {'MAM', 'JJA', 'SON', 'DJF'}, 'YTick', yTicks(1:(end - 1)), 'YMinorTick', 'on', 'Box', 'on', 'LineWidth', 2, 'TickLen', [0.01, 0.01]);
xlim([0, 5]);
...
set(findall(gcf, '-Property', 'FontName'), 'FontName', 'Times New Roman');
export_fig(gcf, fullfile(projectDir, 'img', figFilename3), '-r300');
...
yTicks = linspace(PMRange(1), PMRange(2), 6);
set(gca, 'XTick', yearlyTime, 'YTick', yTicks(2:(end - 1)), 'XTickLabel', '', 'YMinorTick', 'on', 'Box', 'on', 'LineWidth', 2, 'TickLen', [0.01, 0.01]);
...
yTicks = linspace(O3Range(1), O3Range(2), 6);
set(gca, 'XTick', yearlyTime, 'YTick', yTicks(2:(end - 1)), 'YMinorTick', 'on', 'Box', 'on', 'LineWidth', 2, 'TickLen', [0.01, 0.01]);
datetick(gca, 'x', 'yyyy', 'keepticks', 'keeplimits');
xlim([floor(time(1)), ceil(time(end)) + 1]);
...
set(findall(gcf, '-Property', 'FontName'), 'FontName', 'Times New Roman');
export_fig(gcf, fullfile(projectDir, 'img', figFilename4), '-r300');
...
% right-top
subplot('Position', figPos(2, :), 'Units', 'Normalized');
bar(diurnalTime - datenum(0, 1, 0, 0, 10, 0), squeeze(seasonalDiurnalDataMean(3, 2, :)), 0.3, 'r', 'DisplayName', 'PM2.5'); hold on;
bar(diurnalTime + datenum(0, 1, 0, 0, 10, 0), squeeze(seasonalDiurnalDataMean(4, 2, :)), 0.3, 'b', 'DisplayName', 'PM10'); hold on;
...
% bottom-left
subplot('Position', figPos(3, :), 'Units', 'Normalized');
bar(diurnalTime - datenum(0, 1, 0, 0, 10, 0), squeeze(seasonalDiurnalDataMean(3, 3, :)), 0.3, 'r', 'DisplayName', 'PM2.5'); hold on;
bar(diurnalTime + datenum(0, 1, 0, 0, 10, 0), squeeze(seasonalDiurnalDataMean(4, 3, :)), 0.3, 'b', 'DisplayName', 'PM10'); hold on;
...
yTicks = linspace(PMRange(1), PMRange(2), 6);
set(gca, 'XTick', diurnalTime(1:2:end), 'YTick', yTicks(2:(end - 1)), 'YMinorTick', 'on', 'Box', 'on', 'LineWidth', 2, 'TickLen', [0.01, 0.01]);
datetick(gca, 'x', 'HH', 'keepticks', 'keeplimits');
xlim([0, 1]);
...
% bottom-right
subplot('Position', figPos(4, :), 'Units', 'Normalized');
bar(diurnalTime - datenum(0, 1, 0, 0, 10, 0), squeeze(seasonalDiurnalDataMean(3, 4, :)), 0.3, 'r', 'DisplayName', 'PM2.5'); hold on;
...
set(findall(gcf, '-Property', 'FontName'), 'FontName', 'Times New Roman');
export_fig(gcf, fullfile(projectDir, 'img', figFilename5), '-r300');
...
% right-top
subplot('Position', figPos(2, :), 'Units', 'Normalized');
bar(diurnalTime, squeeze(seasonalDiurnalDataMean(1, 2, :)), 0.5, 'k', 'DisplayName', 'AQI'); hold on;
...
% bottom-left
subplot('Position', figPos(3, :), 'Units', 'Normalized');
bar(diurnalTime, squeeze(seasonalDiurnalDataMean(1, 3, :)), 0.5, 'k', 'DisplayName', 'AQI'); hold on;
...
% bottom-right
subplot('Position', figPos(4, :), 'Units', 'Normalized');
bar(diurnalTime, squeeze(seasonalDiurnalDataMean(1, 4, :)), 0.5, 'k', 'DisplayName', 'AQI'); hold on;
...
set(findall(gcf, '-Property', 'FontName'), 'FontName', 'Times New Roman');
export_fig(gcf, fullfile(projectDir, 'img', figFilename6), '-r300');
...
% right-top
subplot('Position', figPos(2, :), 'Units', 'Normalized');
bar(diurnalTime, squeeze(seasonalDiurnalDataMean(2, 2, :)), 0.5, 'y', 'DisplayName', 'SO2'); hold on;
...
% bottom-left
subplot('Position', figPos(3, :), 'Units', 'Normalized');
bar(diurnalTime, squeeze(seasonalDiurnalDataMean(2, 3, :)), 0.5, 'y', 'DisplayName', 'SO2'); hold on;
...
% bottom-right
subplot('Position', figPos(4, :), 'Units', 'Normalized');
bar(diurnalTime, squeeze(seasonalDiurnalDataMean(2, 4, :)), 0.5, 'y', 'DisplayName', 'SO2'); hold on;
...
set(findall(gcf, '-Property', 'FontName'), 'FontName', 'Times New Roman');
export_fig(gcf, fullfile(projectDir, 'img', figFilename7), '-r300');
...
% right-top
subplot('Position', figPos(2, :), 'Units', 'Normalized');
bar(diurnalTime, squeeze(seasonalDiurnalDataMean(5, 2, :)), 0.5, 'm', 'DisplayName', 'NO2'); hold on;
...
% bottom-left
subplot('Position', figPos(3, :), 'Units', 'Normalized');
bar(diurnalTime, squeeze(seasonalDiurnalDataMean(5, 3, :)), 0.5, 'm', 'DisplayName', 'NO2'); hold on;
...
% bottom-right
subplot('Position', figPos(4, :), 'Units', 'Normalized');
bar(diurnalTime, squeeze(seasonalDiurnalDataMean(5, 4, :)), 0.5, 'm', 'DisplayName', 'NO2'); hold on;
...
set(findall(gcf, '-Property', 'FontName'), 'FontName', 'Times New Roman');
export_fig(gcf, fullfile(projectDir, 'img', figFilename8), '-r300');
...
% right-top
subplot('Position', figPos(2, :), 'Units', 'Normalized');
bar(diurnalTime, squeeze(seasonalDiurnalDataMean(6, 2, :)), 0.5, 'g', 'DisplayName', 'O3'); hold on;
...
% bottom-left
subplot('Position', figPos(3, :), 'Units', 'Normalized');
bar(diurnalTime, squeeze(seasonalDiurnalDataMean(6, 3, :)), 0.5, 'g', 'DisplayName', 'O3'); hold on;
...
% bottom-right
subplot('Position', figPos(4, :), 'Units', 'Normalized');
bar(diurnalTime, squeeze(seasonalDiurnalDataMean(6, 4, :)), 0.5, 'g', 'DisplayName', 'O3'); hold on;
...
set(findall(gcf, '-Property', 'FontName'), 'FontName', 'Times New Roman');
export_fig(gcf, fullfile(projectDir, 'img', figFilename9), '-r300');
...
% right-top
subplot('Position', figPos(2, :), 'Units', 'Normalized');
bar(diurnalTime, squeeze(seasonalDiurnalDataMean(7, 2, :)), 0.5, 'c', 'DisplayName', 'CO'); hold on;
...
% bottom-left
subplot('Position', figPos(3, :), 'Units', 'Normalized');
bar(diurnalTime, squeeze(seasonalDiurnalDataMean(7, 3, :)), 0.5, 'c', 'DisplayName', 'CO'); hold on;
...
export_fig(gcf, fullfile(projectDir, 'img', figFilename10), '-r300');